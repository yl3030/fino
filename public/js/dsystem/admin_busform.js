...
(function ($, window, i) {
    ...
    var BusFormHelper = function(){
        this.rootView = $('#busform-page');
        this.form = $('#busform_form');
  ...
  //       this.crtBtn.click(function (){
        ...
        this.tableBuilder = new TableBuilder(this.tableView, this.pagination, 'form_id',
        	['form_id', 'username', 'company', 'email', 'phone', 'crtime'],
        	['td', 'td', 'td', 'td', 'td', 'td'], function(data) {
    ...
    BusFormHelper.prototype.getList = function(num, start) {
    ...
    BusFormHelper.prototype.create = function() {
    ...
    BusFormHelper.prototype.edit = function() {
    ...
    BusFormHelper.prototype.getFormData = function() {
    ...
    BusFormHelper.prototype.get = function(id) {
    ...
    BusFormHelper.prototype.delete = function(id) {
    ...
    BusFormHelper.prototype.editorInit = function() {
        this.form[0].reset();
    };

    busFormHelper = new BusFormHelper();
    busFormHelper.getList(20, shopPage);

})(jQuery, this, 0);



// var imgHelper = new UploaderHelper($('#busform-page .photo-con'));
